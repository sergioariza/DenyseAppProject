package views.details
{
	...
	public class StageWebViewUIComponent extends UIComponent
	{
		...
		public function set stageWebView(parameter:StageWebView):void
		{
			_stageWebView = parameter;
		}
		...
		protected function addedToStageHandler(event:Event):void
		{
			...
			_stageWebView.stage = myStage;
			//_stageWebView.viewPort = new Rectangle(xOffset, yOffset, myStage.width, myStage.fullScreenHeight - yOffset);
			_stageWebView.viewPort = new Rectangle(xOffset, yOffset, mapWidth, mapHeight);
		...
		public function moveVertical(yParam:Number):void
		{
			_stageWebView.viewPort = new Rectangle(xOffset, yOffset - yParam, mapWidth, mapHeight);
			trace("New height: " + (yOffset - yParam));
		}

		public function moveHorizontal(xParam:Number):void
		{
			_stageWebView.viewPort = new Rectangle(xOffset - xParam, yOffset, mapWidth, mapHeight);
			trace("New width: " + (xOffset - xParam));
		}
	}
}
